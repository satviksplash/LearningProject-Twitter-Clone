...
export const GET_USER_PROILE_REQUEST = 'GET_USER_PROILE_REQUEST';
export const GET_USER_PROILE_SUCCESS = 'GET_USER_PROILE_SUCCESS';
export const GET_USER_PROILE_FAILURE = 'GET_USER_PROILE_FAILURE';
